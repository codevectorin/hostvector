            ...
            <div class=\"container invisible\" data-animate data-animation-classes=\"animated fadeIn\" data-animation-delay=\"500\">
                ...
                <div class=\"columns list is-multiline is-mobile invisible\" data-animate data-animation-classes=\"animated fadeInUp\" data-animation-delay=\"500\">
                    ...
                    <div class=\"column has-icon\">
                        ...
                        <h3 class=\"title is-4\">Cloudflare</h3>
                        <p>Use Cloudflare to secure your site against attacks, improve performance, get rich analytics, and much more for your site.</p>
                    </div>
                    <div class=\"column has-icon\">
                        <figure class=\"image is-32x32\">
                            <img src=\"./assets/img/database.svg\"/>
                        </figure>
                        <h3 class=\"title is-4\">Database</h3>
                        <p>Use databasing capabilities using Mysql. phpmyadmin is also available for your modifications</p>
                    </div>
                    <div class=\"column has-icon\">
                        <figure class=\"image is-32x32\">
                            <img src=\"./assets/img/antivirus.svg\"/>
                        </figure>
                        <h3 class=\"title is-4\">ClamAV&reg; Antivirus</h3>
                        <p>Use ClamAV&reg; antivirus engine to detect trojans, viruses, malware &amp; other malicious threats.</p>
                    </div>
                    <div class=\"column has-icon\">
                        <figure class=\"image is-32x32\">
                        ...
                        <p>Backup and Restore your site safely with easy to use backup tools. </p>
                    </div>
                    <div class=\"column has-icon\">
                        <figure class=\"image is-32x32\">
                            <img src=\"./assets/img/php.svg\"/>
                        </figure>
                        <h3 class=\"title is-4\">PHP</h3>
                        <p>PHP interpreters with multiple version manager and INI editor.<b>maybechange</b></p>
                    </div>
                    <div class=\"column has-icon\">
                        <figure class=\"image is-32x32\">
                            <img src=\"./assets/img/perl.svg\"/>
                        </figure>
                        <h3 class=\"title is-4\">PERL</h3>
                        <p>PERL 5 for both rapid prototyping and large scale development projects.</p>
                    </div>
                    <div class=\"column has-icon\">
                        <figure class=\"image is-32x32\">
                            <img src=\"./assets/img/seo.svg\"/>
                        </figure>
                        <h3 class=\"title is-4\">SEO Tools</h3>
                        <p>Use our free SEO Tools for better SERP Ranking and more visitors.<b>change</b></p>
                    </div>
                    <div class=\"column has-icon\">
                        <figure class=\"image is-32x32\">
                            <img src=\"./assets/img/ssh.svg\"/>
                        </figure>
                        <h3 class=\"title is-4\">SSH Access</h3>
                        <p>Secure SSH Access with key based login for secure file transfer and remote logins over the internet.</p>
                    </div>
                    <div class=\"column has-icon\">
                        <figure class=\"image is-32x32\">
  ...
  <div class=\"hero-body\" id=\"title-box\">
    ...
    <div class=\"column is-narrow post-image\">
      <figure class=\"image is-128x128\">
                  ...
                  <img src=\"https://rockitech.net/static/article-pics/getting-started-webassembly.png\" title=\"Getting started with WebAssembly!\" alt=\"Getting started with WebAssembly!\">
...
";
    ...
    {
        return new Twig_Source("", "home/index.html", "/var/www/html/Projects/hv/vendor/app/views/home/index.html");
    }
}
